...
public class QuizController2_2 : MonoBehaviour
{
    ...
    private CSVReader_Lv2 QuizInfo;//CSVを読み込むCSVReader_Lv1クラスを扱うために宣言
    ...
    private void Start()
    {
        ...
        QuizInfo = new CSVReader_Lv2();//CSVReader_Lv1クラスの実体としてQuizInfo生成
