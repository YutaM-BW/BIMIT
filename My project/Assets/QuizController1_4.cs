...
public class QuizController1_4 : MonoBehaviour
{
    ...
    private CSVReader_Lv1 QuizInfo;//CSVを読み込むCSVReader_Lv1クラスを扱うために宣言
    ...
    private void Start()
    {
        ...
        QuizInfo = new CSVReader_Lv1();//CSVReader_Lv1クラスの実体としてQuizInfo生成
