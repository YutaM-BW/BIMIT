...
public class QuizController4_1 : MonoBehaviour
{
    ...
    private CSVReader_Lv4 QuizInfo;//CSVを読み込むCSVReader_Lv1クラスを扱うために宣言
    ...
    private void Start()
    {
        ...
        QuizInfo = new CSVReader_Lv4();//CSVReader_Lv1クラスの実体としてQuizInfo生成
